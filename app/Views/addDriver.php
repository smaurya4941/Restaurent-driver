                ...
                <div class="col-lg-12">
                        <form action="<?= site_url('drivers') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="card ops-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="default_cash_incentive_amount">Default Incentive (₹) <span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="whatsapp_opt_out_reason" id="whatsapp_opt_out_reason" class="form-control <?= isset($errors['whatsapp_opt_out_reason']) ? 'is-invalid' : '' ?>" value="<?= old('whatsapp_opt_out_reason') ?>" placeholder="Optional reason">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="photo_path">Choose photo</label>
                                                </div>
                                                <div class="camera-capture mt-2" data-camera-capture data-input="photo_path">
                                                    <div class="camera-capture__actions">
                                                        <button type="button" class="btn btn-outline-enterprise btn-sm" data-camera-start>Capture Photo</button>
                                                        <button type="button" class="btn btn-primary-enterprise btn-sm" data-camera-snap style="display:none;">Use This</button>
                                            ...
                                            <div class="form-group mb-0">
                                                <label for="license_photo_path">License Document</label>
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="license_photo_path">Choose document</label>
                                                </div>
                                                <div class="camera-capture mt-2" data-camera-capture data-input="license_photo_path">
                                                    <div class="camera-capture__actions">
                                                        <button type="button" class="btn btn-outline-enterprise btn-sm" data-camera-start>Capture License</button>
                                                        <button type="button" class="btn btn-primary-enterprise btn-sm" data-camera-snap style="display:none;">Use This</button>
                                                        <button type="button" class="btn btn-outline-secondary btn-sm" data-camera-stop style="display:none;">Cancel</button>
                                                    </div>
                                                    <video class="camera-capture__media" data-camera-video playsinline></video>
                            ...
                            <div class="d-flex justify-content-end mb-4" style="gap:0.5rem;">
                                <a href="<?= base_url('drivers') ?>" class="btn btn-outline-enterprise"><i class="fas fa-arrow-left mr-1"></i> Back</a>
                                <button type="reset" class="btn btn-outline-enterprise"><i class="fas fa-undo mr-1"></i> Reset</button>
                                <button type="submit" class="btn btn-primary-enterprise"><i class="fas fa-save mr-1"></i> Save Driver</button>
                            </div>
                        </form>
                </div>
            </div>
