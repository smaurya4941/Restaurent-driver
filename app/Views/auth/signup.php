...
<head>
    ...
    <title><?= lang('App.register_title') ?></title>
    ...
    <?php foreach (['success', 'Required', 'Sorry'] as $flashKey): ?>
        <?php if (session()->getFlashdata($flashKey)): ?>
            <div class="alert alert-<?= in_array($flashKey, ['Required', 'Sorry'], true) ? 'danger' : 'success' ?> ops-alert">
                <i class="fas <?= in_array($flashKey, ['Required', 'Sorry'], true) ? 'fa-exclamation-circle' : 'fa-check-circle' ?> mr-2"></i>
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="<?= lang('App.enter_mobile') ?>" required autocomplete="tel">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="password" name="password" placeholder="<?= lang('App.enter_password') ?>" required autocomplete="new-password">
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="<?= lang('App.enter_confirm_password') ?>" required autocomplete="new-password">
                        <div class="input-group-append">
                            <div class="input-group-text"><span class="fas fa-lock"></span></div>
                        </div>
                    </div>
                ...
                <div class="icheck-primary mb-4 mt-3">
                    <input type="checkbox" id="agreeTerms" name="terms" value="agree" required>
                    <label for="agreeTerms"><?= lang('App.agree_terms') ?> <a href="#" class="auth-link"><?= lang('App.terms') ?></a></label>
                </div>
                
                <button type="submit" class="btn btn-primary-enterprise">
                    <?= lang('App.create_account') ?> <i class="fas fa-user-plus ml-1"></i>
                </button>
            </form>
            
            <div class="text-center mt-4 pt-3 border-top">
                <a href="<?php echo base_url()?>" class="auth-link"><?= lang('App.already_have_account') ?></a>
            </div>
        </div>
    </div>
