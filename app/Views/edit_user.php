...
<?php
$pageTitle = lang('App.edit_employee');
$pageSubtitle = lang('App.edit_employee_desc', [$user['name'] ?? 'this user']);
$pageEyebrow = lang('App.administration');
$breadcrumbs = [
    ['label' => lang('App.home'), 'url' => base_url('dashboard')],
    ['label' => lang('App.users'), 'url' => base_url('user_list')],
    ['label' => lang('App.edit_employee'), 'active' => true],
];
?>
            ...
            <div class="row">
                    ...
                    <div class="card ops-card mb-4">
                        <div class="card-header ops-toolbar">
                            <div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: center;">
                                <h3 class="card-title mb-0" style="float: none; line-height: 1.2;"><?= lang('App.employee_access_controls') ?></h3>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="branch_id" name="branch_id" class="form-control">
                                                    <option value=""><?= lang('App.no_branch_super_admin') ?></option>
                            ...
                            <div class="card-footer" style="background: #F8F9FA; border-top: 1px solid #E0E0E0; display: flex; gap: 10px;">
                                <button type="submit" class="btn btn-primary-enterprise"><i class="fas fa-save mr-1"></i> <?= lang('App.update_user') ?></button>
                ...
                <div class="col-lg-4">
                    <div class="card ops-card">
                        <div class="card-header ops-toolbar">
                            <div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: center;">
                                <h3 class="card-title mb-0" style="float: none; line-height: 1.2;"><?= lang('App.password_reset') ?></h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <div style="font-family: 'JetBrains Mono', monospace; font-size: 11px; color: #4F4255; margin-bottom: 16px;">
                                <?= lang('App.password_reset_desc') ?>
                            </div>
                            <form action="<?= base_url('reset_user_password/' . $user['id']) ?>" method="post">
                                ...
                                <button type="submit" class="btn btn-outline-enterprise w-100 text-danger" style="border-color: #F43F5E;"><i class="fas fa-key mr-1"></i> <?= lang('App.password_reset') ?></button>
                            </form>
                        </div>
                    </div>
                </div>
